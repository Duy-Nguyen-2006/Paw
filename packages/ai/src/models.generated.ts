...
export const MODELS = {
	...
	"minimax": {
		...
		"MiniMax-M3": {
			...
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":false,"maxTokensField":"max_tokens","thinkingFormat":"zai","supportsStrictMode":false,"supportsLongCacheRetention":false},
			reasoning: true,
			input: ["text", "image"],
			cost: {
				input: 0.6,
